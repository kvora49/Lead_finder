      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700
        ...
        <div className="relative">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
            Find leads<br />anywhere on Earth.
          </h1>
          <p className="text-indigo-200 text-lg max-w-sm leading-relaxed mb-12">
            Bypass Google&apos;s 60-result limit with our Dynamic Grid Search — pull hundreds
            of verified leads from any city worldwide.
          </p>

          <div className="grid grid-cols-2 gap-4 max-w-xs">
            {[
              { label: 'Leads per search',     value: '500+' },
              { label: 'Countries supported',  value: '195'  },
              { label: 'Export formats',       value: 'CSV & PDF' },
              { label: 'Free searches/month',  value: '6,250' },
            ].map(({ label, value }) => (
