...
export const CREDIT_CONFIG = {
  ...
  DEFAULT_USER_BUDGET_USD: 50,      // Default monthly budget assigned per user
  COST_PER_REQUEST_USD:    0.032,   // Google's per-call price
  FREE_TIER_USD:           200,     // Monthly free budget from Google
  PLATFORM_CAP_USD:        195,     // Internal safety cap to avoid overage
...
export const CREDIT_PRICING = {
  ...
  PLATFORM_CAP_USD:    CREDIT_CONFIG.PLATFORM_CAP_USD,
  DEFAULT_USER_BUDGET_USD: CREDIT_CONFIG.DEFAULT_USER_BUDGET_USD,
